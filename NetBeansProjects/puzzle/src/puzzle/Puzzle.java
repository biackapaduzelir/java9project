...
class MyButton extends JButton { private boolean isLastButton; 
public MyButton() { 
    super(); initUI(); } 
...
private void initUI() {
    isLastButton = false; 
    BorderFactory.createLineBorder(Color.gray); addMouseListener(new MouseAdapter() { 
        @Override
...
public void setLastButton() { isLastButton = true; } 
...
public class Puzzle extends JFrame { 
    ...
    private void initUI() {
        ...
        } catch (IOException ex) { Logger.getLogger(Puzzle.class.getName()).log( Level.SEVERE, null, ex); 
        } 
...
panel.validate(); } } 
    ...
    public static void main(String[] args) { 
        EventQueue.invokeLater(() -> { Puzzle puzzle = new Puzzle(); puzzle.setVisible(true); }); } }